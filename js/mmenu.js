!function(e) {
  ...
  class O {
      ...
      openPanel(e, t=!0, n=!0) {
          if (e) {
              if (e.matches(".mm-panel") || (e = e.closest(".mm-panel")),
      ...
      _initPanel(e) {
          var t;
          if (!e.matches(".mm-panel") && (y(e, this.conf.classNames.panel, "mm-panel"),
      ...
      _initNavbar(e) {
          ...
          const o = g("span");
          var l;
          o.innerHTML = e.dataset.mmTitle || ((l = i) ? [].slice.call(l.childNodes).filter(e=>e.nodeType === Node.TEXT_NODE).map(e=>e.nodeValue.trim()).join(" ") : "") || this.i18n(this.opts.navbar.title) || this.i18n("Menu"),
          e.prepend(s),
          s.append(a),
          a.append(o),
      ...
      _initListview(e) {
          ["htmlulistelement", "htmlolistelement"].includes(o(e)) && (e.matches(".mm-listview") || (y(e, this.conf.classNames.nolistview, "mm-nolistview"),
      ...
      _initListitem(e) {
          ["htmllielement"].includes(o(e)) && (e.matches(".mm-listitem") || (y(e, this.conf.classNames.divider, "mm-divider"),
    ...
    , te = function(e) {
      ...
      const a = ()=>{
          ...
          a.length) {
              ...
              n.matches(".mm-panel--search") ? (se(n),
              t.splash || this.closePanel(n, !1, !1)) : ae(i),
  ...
  O.addons = {
      offcanvas: function() {
          ...
          this.bind("initMenu:after", ()=>{
              ...
              this.node.menu.classList.add("mm-menu--offcanvas", "mm-menu--position-" + e.position);
          ...
          document.addEventListener("focusin", e=>{
              ...
              (null === (n = document.activeElement) || void 0 === n ? void 0 : n.closest("#" + this.node.menu.id)) || this.node.wrpr.matches(".mm-wrapper--sidebar-expanded") || !this.node.menu.matches(".mm-menu--opened") || this.close()
          }
          )
      },
      scrollBugFix: function() {
          if (!I || !this.opts.offCanvas.use)
              return;
          this.opts.scrollBugFix = this.opts.scrollBugFix || {};
          if (!a(this.opts.scrollBugFix, j).fix)
              return;
          const e = (e=>{
              let t = ""
                , n = null;
      ...
      iconbar: function() {
          ...
          t) {
              ...
              ;
              if ("boolean" == typeof e.use ? this.bind("initMenu:after", s) : S(e.use, s, i),
              "tabs" == e.type) {
      ...
      iconPanels: function() {
          ...
          e.add) {
              ...
              t ? this.bind("initMenu:after", ()=>{
                  ...
                  if (t.parentElement.matches(".mm-listitem--vertical"))
                      return;
      ...
      sectionIndexer: function() {
          ...
          a(this.opts.sectionIndexer, le).add && this.bind("initPanels:after", ()=>{
              if (!this.node.indx) {
                  ...
                  ;
                  I ? (this.node.indx.addEventListener("touchstart", n),
          ...
          if (e.collapsed.use) {
              this.bind("initMenu:after", ()=>{
                  ...
                  e.collapsed.blockMenu && !this.node.blck) {
                      ...
                      e.title = this.i18n(this.conf.offCanvas.screenReader.openMenu)
                  }
              }
              );
              const t = ()=>{
